    ...
    useEffect(() => {
     ...
     function updateStudent() {
        ...
        if (firstName.length > 0 && lastName.length > 0 && DOB.length > 0) {
             axios.put(BaseUrl + "student/" + student_id + "/", data, {
                headers: {
        ...
        <div>
            ...
            <div className="center-form">
                ...
                <div className="input-form">
                    ...
                    <br/>
                    <input type={"date"} id={"dob"} value={DOB} onChange={dobHandler}/>
                    <br/>

                    <button className="btn btn-info" onClick={updateStudent}>Update</button>
